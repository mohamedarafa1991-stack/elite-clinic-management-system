...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------- |
| Database migrations         | The encrypted Hub database opens at migration version 24 after creation and after restore.                                                                         | Passed.                             |
...
| `database.migrationVersion`                                   | Must be `24` for the current repository.                                                                                           |
