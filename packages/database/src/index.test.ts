...
describe("Elite database foundation", () => {
  it("opens synthetic test storage and applies the foundation migration", () => {
    ...
    try {
      ...
      expect(tables).toContain("billing_doctor_compensation_rules");
      expect(tables).toContain("billing_doctor_earnings");
      expect(tables).toContain("billing_payments");
      expect(tables).toContain("billing_refunds");
      expect(tables).toContain("billing_receipts");
      expect(tables).toContain("doctor_profiles");
      expect(tables).toContain("doctor_documents");
      expect(tables).toContain("drug_catalog_snapshots");
      expect(tables).toContain("drug_catalog_entries");
      ...
      expect(syncCursorSchema.sql).toContain("doctor-summary");
      ...
      expect(tables).toContain("export_recipients");
      expect(tables).toContain("export_consent_evidence");
      ...
      expect(tables).toContain("android_enrollment_challenges");
      expect(tables).toContain("android_enrollment_requests");
      expect(tables).toContain("android_enrollment_records");
      expect(tables).toContain("android_enrollment_events");
